...
const GiftSection = ({ sectionData, type }) => {
  ...
  const validationSchema = yup.object({
    ...
    giftTitle: yup.string().required("Gift title is required"),
    redirectUrl: yup
      .string()
  ...
  const validation = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        bodyFormData.append("giftTitle", values.giftTitle);
        ...
        <Modal.Body>
          ...
          <div className="mt-3">
            <InputField
              ...
              name="giftTitle"
              id="giftTitle"
              value={validation.values.giftTitle}
              onChange={validation.handleChange}
              onReset={validation.handleReset}
              onBlur={validation.handleBlur}
              isValid={
                validation.touched.giftTitle && validation.errors.giftTitle
              }
              errorMessage={validation.errors.giftTitle}
            />
          </div>
          <div className="mt-3">
            <InputField
              ...
              onBlur={validation.handleBlur}
              isValid={
                validation.touched.redirectUrl && validation.errors.redirectUrl
              }
