              ...
              return (
                <SwiperSlide key={index} className="mb-0">
                  <div className="bg-color-primary br-10 position-relative overflow-hidden zoom-hover">
                    <div className="gifting-box cursor-pointer">
                      <Link to={redirectUrl} target="_blank">
                        ...
                        />
                        {item?.giftTitle && (
                          <button className="responsive-2 truncate-line-2 px-2 py-1 py-sm-1 position-absolute bottom-0 start-0 end-0 m-2 m-sm-3 white-btn fs-18 text-capitalize fw-medium">
                            {item?.giftTitle}
                          </button>
                        )}
                      </Link>
